...
import { listIrcAccountIds, resolveDefaultIrcAccountId, resolveIrcAccount } from "./accounts.ts";
import {
  isChannelTarget,
  normalizeIrcAllowEntry,
  normalizeIrcMessagingTarget,
} from "./normalize.ts";
import type { CoreConfig, IrcAccountConfig, IrcNickServConfig } from "./types.ts";
