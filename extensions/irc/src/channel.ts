...
import { IrcConfigSchema } from "./config-schema.ts";
import { monitorIrcProvider } from "./monitor.ts";
import {
...
import { ircOnboardingAdapter } from "./onboarding.ts";
import { resolveIrcGroupMatch, resolveIrcRequireMention } from "./policy.ts";
import { probeIrc } from "./probe.ts";
import { getIrcRuntime } from "./runtime.ts";
import { sendMessageIrc } from "./send.ts";
import type { CoreConfig, IrcProbe } from "./types.ts";
