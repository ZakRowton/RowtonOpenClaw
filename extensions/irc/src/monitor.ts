...
import { resolveIrcAccount } from "./accounts.ts";
import { connectIrcClient, type IrcClient } from "./client.ts";
import { buildIrcConnectOptions } from "./connect-options.ts";
import { handleIrcInbound } from "./inbound.ts";
import { isChannelTarget } from "./normalize.ts";
import { makeIrcMessageId } from "./protocol.ts";
import { getIrcRuntime } from "./runtime.ts";
import type { CoreConfig, IrcInboundMessage } from "./types.ts";
