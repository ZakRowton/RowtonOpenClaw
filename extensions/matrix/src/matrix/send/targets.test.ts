...
let resolveMatrixRoomId: typeof import("./targets.ts").resolveMatrixRoomId;
let normalizeThreadId: typeof import("./targets.ts").normalizeThreadId;

beforeEach(async () => {
  vi.resetModules();
  ({ resolveMatrixRoomId, normalizeThreadId } = await import("./targets.ts"));
});
