...
import { matrixMessageActions } from "./actions.ts";
import { MatrixConfigSchema } from "./config-schema.ts";
import { listMatrixDirectoryGroupsLive, listMatrixDirectoryPeersLive } from "./directory-live.ts";
import {
  resolveMatrixGroupRequireMention,
  resolveMatrixGroupToolPolicy,
} from "./group-mentions.ts";
import {
...
} from "./matrix/accounts.ts";
import { resolveMatrixAuth } from "./matrix/client.ts";
import { normalizeMatrixAllowList, normalizeMatrixUserId } from "./matrix/monitor/allowlist.ts";
import { probeMatrix } from "./matrix/probe.ts";
import { sendMessageMatrix } from "./matrix/send.ts";
import { matrixOnboardingAdapter } from "./onboarding.ts";
import { matrixOutbound } from "./outbound.ts";
import { resolveMatrixTargets } from "./resolve-targets.ts";
...
export const matrixPlugin: ChannelPlugin<ResolvedMatrixAccount> = {
  ...
  gateway: {
    startAccount: async (ctx) => {
      ...
      let monitorMatrixProvider: typeof import("./matrix/index.ts").monitorMatrixProvider;
      try {
        const module = await import("./matrix/index.ts");
