...
import { resolveNextcloudTalkAccount } from "./accounts.ts";
import { handleNextcloudTalkInbound } from "./inbound.ts";
import { getNextcloudTalkRuntime } from "./runtime.ts";
import { extractNextcloudTalkHeaders, verifyNextcloudTalkSignature } from "./signature.ts";
import type {
  CoreConfig,
