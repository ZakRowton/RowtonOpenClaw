...
import { bluebubblesMessageActions } from "./actions.ts";
import { getCachedBlueBubblesPrivateApiStatus } from "./probe.ts";
...
describe("bluebubblesMessageActions", () => {
  ...
  describe("handleAction", () => {
    ...
    it("resolves short messageId before reacting", async () => {
      const { resolveBlueBubblesMessageId } = await import("./monitor.ts");
      const { sendBlueBubblesReaction } = await import("./reactions.ts");
    ...
    it("accepts message param for edit action", async () => {
      const { editBlueBubblesMessage } = await import("./chat.ts");
    ...
    it("passes asVoice through sendAttachment", async () => {
      const { sendBlueBubblesAttachment } = await import("./attachments.ts");
    ...
    it("sets group icon successfully with chatGuid and buffer", async () => {
      const { setGroupIconBlueBubbles } = await import("./chat.ts");
