...
import type { OpenClawPluginApi, OpenClawPluginToolContext } from "../../../src/plugins/types.ts";
import {
...
let createLobsterTool: typeof import("./lobster-tool.ts").createLobsterTool;
...
describe("lobster plugin tool", () => {
  ...
  beforeAll(async () => {
    ({ createLobsterTool } = await import("./lobster-tool.ts"));
