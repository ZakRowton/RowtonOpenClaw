...
import { isLocalDirectRequest } from "../../auth.ts";
import {
  buildCanvasScopedHostUrl,
  CANVAS_CAPABILITY_TTL_MS,
  mintCanvasCapabilityToken,
} from "../../canvas-capability.ts";
...
} from "../../protocol/connect-error-details.ts";
import {
  type ConnectParams,
  ErrorCodes,
  type ErrorShape,
...
import { formatGatewayAuthFailureMessage, type AuthProvidedKind } from "./auth-messages.ts";
import {
