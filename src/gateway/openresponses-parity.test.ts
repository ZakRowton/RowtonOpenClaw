...
let InputImageContentPartSchema: typeof import("./open-responses.schema.ts").InputImageContentPartSchema;
let InputFileContentPartSchema: typeof import("./open-responses.schema.ts").InputFileContentPartSchema;
let ToolDefinitionSchema: typeof import("./open-responses.schema.ts").ToolDefinitionSchema;
let CreateResponseBodySchema: typeof import("./open-responses.schema.ts").CreateResponseBodySchema;
let OutputItemSchema: typeof import("./open-responses.schema.ts").OutputItemSchema;
let buildAgentPrompt: typeof import("./openresponses-prompt.ts").buildAgentPrompt;
...
describe("OpenResponses Feature Parity", () => {
  beforeAll(async () => {
    ({
      ...
      OutputItemSchema,
    } = await import("./open-responses.schema.ts"));
    ({ buildAgentPrompt } = await import("./openresponses-prompt.ts"));
  });
