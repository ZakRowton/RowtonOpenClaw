...
import { classifySessionKeyShape, normalizeAgentId } from "../../routing/session-key.ts";
...
import { GATEWAY_CLIENT_CAPS, hasGatewayClientCap } from "../protocol/client-info.ts";
import {
  ErrorCodes,
  errorShape,
...
import type { GatewayRequestHandlerOptions, GatewayRequestHandlers } from "./types.ts";
