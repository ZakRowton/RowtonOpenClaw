...
import { stripEnvelopeFromMessage, stripEnvelopeFromMessages } from "../chat-sanitize.ts";
...
import { appendInjectedAssistantMessageToTranscript } from "./chat-transcript-inject.ts";
