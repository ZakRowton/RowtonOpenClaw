...
import { BARE_SESSION_RESET_PROMPT } from "../../auto-reply/reply/session-reset-prompt.ts";
import { agentHandlers } from "./agent.ts";
...
vi.mock("../session-utils.js", async () => {
  const actual = await vi.importActual<typeof import("../session-utils.ts")>("../session-utils.js");
  return {
    ...actual,
...
vi.mock("../../utils/delivery-context.js", async () => {
  const actual = await vi.importActual<typeof import("../../utils/delivery-context.ts")>(
