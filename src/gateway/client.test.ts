...
vi.mock("../infra/device-auth-store.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../infra/device-auth-store.ts")>();
  return {
    ...actual,
...
vi.mock("../infra/device-pairing.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../infra/device-pairing.ts")>();
  return {
    ...actual,
...
const { GatewayClient } = await import("./client.ts");
