...
let fetchWithGuard: typeof import("./input-files.ts").fetchWithGuard;
let extractImageContentFromSource: typeof import("./input-files.ts").extractImageContentFromSource;
let extractFileContentFromSource: typeof import("./input-files.ts").extractFileContentFromSource;

beforeAll(async () => {
  ({ fetchWithGuard, extractImageContentFromSource, extractFileContentFromSource } =
    await import("./input-files.ts"));
});
