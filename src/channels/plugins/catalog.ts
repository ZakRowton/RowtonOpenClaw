...
import { discoverOpenClawPlugins } from "../../plugins/discovery.ts";
import type { OpenClawPackageManifest } from "../../plugins/manifest.ts";
import type { PluginOrigin } from "../../plugins/types.ts";
import { CONFIG_DIR, isRecord, resolveUserPath } from "../../utils.ts";
