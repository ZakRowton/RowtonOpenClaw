...
const { discordMessageActions } = await import("./discord.ts");
const { handleDiscordMessageAction } = await import("./discord/handle-action.ts");
const { telegramMessageActions } = await import("./telegram.ts");
const { signalMessageActions } = await import("./signal.ts");
const { createSlackActions } = await import("../slack.actions.ts");
