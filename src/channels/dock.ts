...
import { normalizeSignalMessagingTarget } from "./plugins/normalize/signal.ts";
import { normalizeWhatsAppAllowFromEntries } from "./plugins/normalize/whatsapp.ts";
import type {
  ChannelCapabilities,
...
} from "./plugins/whatsapp-shared.ts";
