...
import { fileExists, readJsonFile, resolveArchiveKind } from "../infra/archive.ts";
...
import { extensionUsesSkippedScannerPath, isPathInside } from "../security/scan-paths.ts";
