...
import { createEmptyPluginRegistry } from "./registry.ts";
import type { OpenClawPluginService, OpenClawPluginServiceContext } from "./types.ts";
...
import { startPluginServices } from "./services.ts";
