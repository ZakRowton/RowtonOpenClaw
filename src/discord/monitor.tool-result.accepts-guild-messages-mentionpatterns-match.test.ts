...
} from "./monitor.tool-result.test-harness.ts";
import { __resetDiscordChannelInfoCacheForTest } from "./monitor/message-utils.ts";
import { createNoopThreadBindingManager } from "./monitor/thread-bindings.ts";
...
let createDiscordMessageHandler: typeof import("./monitor.ts").createDiscordMessageHandler;
let createDiscordNativeCommand: typeof import("./monitor.ts").createDiscordNativeCommand;

beforeAll(async () => {
  ({ createDiscordMessageHandler, createDiscordNativeCommand } = await import("./monitor.ts"));
});
...
describe("discord tool result dispatch", () => {
  ...
  it(
    ...
    async () => {
      ...
      } as ReturnType<typeof import("../config/config.ts").loadConfig>;
