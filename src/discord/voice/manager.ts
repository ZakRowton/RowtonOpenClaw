...
import type { DiscordAccountConfig, TtsConfig } from "../../config/types.ts";
...
import {
  ...
  runCapability,
} from "../../media-understanding/runner.ts";
import { resolveAgentRoute } from "../../routing/resolve-route.ts";
import type { RuntimeEnv } from "../../runtime.ts";
import { parseTtsDirectives } from "../../tts/tts-core.ts";
import { resolveTtsConfig, textToSpeech, type ResolvedTtsConfig } from "../../tts/tts.ts";
