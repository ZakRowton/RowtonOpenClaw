...
import { resetDiagnosticSessionStateForTest } from "../logging/diagnostic-session-state.ts";
import {
  addSession,
  appendOutput,
  markExited,
...
import { createProcessSessionFixture } from "./bash-process-registry.test-helpers.ts";
import { createProcessTool } from "./bash-tools.process.ts";
