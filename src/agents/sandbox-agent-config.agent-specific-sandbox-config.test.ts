...
import { createRestrictedAgentSandboxConfig } from "./test-helpers/sandbox-agent-config-fixtures.ts";
...
let resolveSandboxContext: typeof import("./sandbox/context.ts").resolveSandboxContext;
let resolveSandboxConfigForAgent: typeof import("./sandbox/config.ts").resolveSandboxConfigForAgent;
let resolveSandboxRuntimeStatus: typeof import("./sandbox/runtime-status.ts").resolveSandboxRuntimeStatus;
...
describe("Agent-specific sandbox config", () => {
  beforeAll(async () => {
    const [configModule, contextModule, runtimeModule] = await Promise.all([
      import("./sandbox/config.ts"),
      import("./sandbox/context.ts"),
      import("./sandbox/runtime-status.ts"),
    ]);
