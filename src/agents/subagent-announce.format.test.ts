...
let configOverride: ReturnType<(typeof import("../config/config.ts"))["loadConfig"]> = {
  session: {
    mainKey: "main",
    scope: "per-sender",
  },
...
describe("subagent announce formatting", () => {
  ...
  let runSubagentAnnounceFlow: (typeof import("./subagent-announce.ts"))["runSubagentAnnounceFlow"];

  beforeAll(async () => {
    ({ runSubagentAnnounceFlow } = await import("./subagent-announce.ts"));
