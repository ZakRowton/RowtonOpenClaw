...
import { createUnsafeMountedSandbox } from "../test-helpers/unsafe-mounted-sandbox.ts";
import { __testing, createImageTool, resolveImageModelConfigForTool } from "./image-tool.ts";
