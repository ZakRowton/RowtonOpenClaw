...
import { clearGateways, registerGateway } from "../../discord/monitor/gateway-registry.ts";
import type { ActionGate } from "./common.ts";
import { handleDiscordPresenceAction } from "./discord-actions-presence.ts";
