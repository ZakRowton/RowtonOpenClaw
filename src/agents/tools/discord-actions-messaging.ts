...
import { readDiscordComponentSpec } from "../../discord/components.ts";
import {
  createThreadDiscord,
...
import type { DiscordSendComponents, DiscordSendEmbeds } from "../../discord/send.shared.ts";
import { resolveDiscordChannelId } from "../../discord/targets.ts";
import { withNormalizedTimestamp } from "../date-time.ts";
import { assertMediaNotDataUrl } from "../sandbox-paths.ts";
import {
  type ActionGate,
  jsonResult,
  readReactionParams,
