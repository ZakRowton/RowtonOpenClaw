...
import { installDownloadSpec } from "./skills-install-download.ts";
import { setTempStateDir } from "./skills-install.download-test-utils.ts";
import {
  fetchWithSsrFGuardMock,
  hasBinaryMock,
  runCommandWithTimeoutMock,
} from "./skills-install.test-mocks.ts";
import { resolveSkillToolsRootDir } from "./skills/tools-dir.ts";
import type { SkillEntry, SkillInstallSpec } from "./skills/types.ts";
...
vi.mock("./skills.js", async (importOriginal) => ({
  ...(await importOriginal<typeof import("./skills.ts")>()),
