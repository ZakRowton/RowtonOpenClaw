...
let callGatewayTool: typeof import("./tools/gateway.ts").callGatewayTool;
let createExecTool: typeof import("./bash-tools.exec.ts").createExecTool;
let detectCommandObfuscation: typeof import("../infra/exec-obfuscation-detect.ts").detectCommandObfuscation;
...
describe("exec approvals", () => {
  ...
  beforeAll(async () => {
    ({ callGatewayTool } = await import("./tools/gateway.ts"));
    ({ createExecTool } = await import("./bash-tools.exec.ts"));
    ({ detectCommandObfuscation } = await import("../infra/exec-obfuscation-detect.ts"));
  });
