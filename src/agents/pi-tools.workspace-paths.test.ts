...
import { createOpenClawCodingTools } from "./pi-tools.ts";
import { createHostSandboxFsBridge } from "./test-helpers/host-sandbox-fs-bridge.ts";
import { expectReadWriteEditTools, getTextContent } from "./test-helpers/pi-tools-fs-helpers.ts";
import { createPiToolsSandboxContext } from "./test-helpers/pi-tools-sandbox-context.ts";

vi.mock("../infra/shell-env.js", async (importOriginal) => {
  const mod = await importOriginal<typeof import("../infra/shell-env.ts")>();
