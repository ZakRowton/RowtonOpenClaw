...
let requestExecApprovalDecision: typeof import("./bash-tools.exec-approval-request.ts").requestExecApprovalDecision;

describe("requestExecApprovalDecision", () => {
  beforeAll(async () => {
    ({ callGatewayTool } = await import("./tools/gateway.ts"));
    ({ requestExecApprovalDecision } = await import("./bash-tools.exec-approval-request.ts"));
  });
