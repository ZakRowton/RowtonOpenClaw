...
let collectTelegramUnmentionedGroupIds: typeof import("./audit.ts").collectTelegramUnmentionedGroupIds;
let auditTelegramGroupMembership: typeof import("./audit.ts").auditTelegramGroupMembership;
