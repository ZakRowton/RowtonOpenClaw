...
import { TELEGRAM_COMMAND_NAME_PATTERN } from "../config/telegram-custom-commands.ts";
...
import { createNativeCommandTestParams } from "./bot-native-commands.test-helpers.ts";
...
vi.mock("../auto-reply/skill-commands.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../auto-reply/skill-commands.ts")>();
  return {
    ...actual,
