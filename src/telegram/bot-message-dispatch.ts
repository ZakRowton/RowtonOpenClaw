...
import type { OpenClawConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.ts";
import { danger, logVerbose } from "../globals.ts";
import { getAgentScopedMediaLocalRoots } from "../media/local-roots.ts";
import type { RuntimeEnv } from "../runtime.ts";
import type { TelegramMessageContext } from "./bot-message-context.ts";
import type { TelegramBotOptions } from "./bot.ts";
import { deliverReplies } from "./bot/delivery.ts";
import type { TelegramStreamMode } from "./bot/types.ts";
import type { TelegramInlineButtons } from "./button-types.ts";
...
import {
  ...
  type DraftLaneState,
  type LaneName,
} from "./lane-delivery.ts";
import {
  createTelegramReasoningStepState,
  splitTelegramReasoningText,
} from "./reasoning-lane-coordinator.ts";
import { editMessageTelegram } from "./send.ts";
