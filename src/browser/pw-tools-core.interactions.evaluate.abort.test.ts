...
let evaluateViaPlaywright: typeof import("./pw-tools-core.interactions.ts").evaluateViaPlaywright;
...
describe("evaluateViaPlaywright (abort)", () => {
  beforeAll(async () => {
    ({ evaluateViaPlaywright } = await import("./pw-tools-core.interactions.ts"));
  });
