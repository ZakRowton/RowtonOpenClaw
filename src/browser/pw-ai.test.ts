...
let snapshotAiViaPlaywright: typeof import("./pw-tools-core.snapshot.ts").snapshotAiViaPlaywright;
let clickViaPlaywright: typeof import("./pw-tools-core.interactions.ts").clickViaPlaywright;
let closePlaywrightBrowserConnection: typeof import("./pw-session.ts").closePlaywrightBrowserConnection;

beforeAll(async () => {
  const pw = await import("playwright-core");
  chromiumMock = pw.chromium;
  ({ snapshotAiViaPlaywright } = await import("./pw-tools-core.snapshot.ts"));
  ({ clickViaPlaywright } = await import("./pw-tools-core.interactions.ts"));
  ({ closePlaywrightBrowserConnection } = await import("./pw-session.ts"));
});
