...
import { applyGroupGating, type GroupHistoryEntry } from "./monitor/group-gating.ts";
import { buildInboundLine, formatReplyContext } from "./monitor/message-line.ts";
...
const makeConfig = (overrides: Record<string, unknown>) =>
  ({
    ...
    ...overrides,
  }) as unknown as ReturnType<typeof import("../../config/config.ts").loadConfig>;

function runGroupGating(params: {
  cfg: ReturnType<typeof import("../../config/config.ts").loadConfig>;
