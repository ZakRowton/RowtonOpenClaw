...
vi.mock("../../agents/model-selection.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../agents/model-selection.ts")>();
  return {
    ...actual,
...
vi.mock("../../routing/session-key.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../routing/session-key.ts")>();
  return {
    ...actual,
...
const { runCronIsolatedAgentTurn } = await import("./run.ts");
