...
import { discordOutbound } from "../../channels/plugins/outbound/discord.ts";
import { imessageOutbound } from "../../channels/plugins/outbound/imessage.ts";
import { signalOutbound } from "../../channels/plugins/outbound/signal.ts";
import { slackOutbound } from "../../channels/plugins/outbound/slack.ts";
import { telegramOutbound } from "../../channels/plugins/outbound/telegram.ts";
import { whatsappOutbound } from "../../channels/plugins/outbound/whatsapp.ts";
import type { ChannelOutboundAdapter, ChannelPlugin } from "../../channels/plugins/types.ts";
...
vi.mock("../../infra/outbound/deliver.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/outbound/deliver.ts")>(
...
const actualDeliver = await vi.importActual<typeof import("../../infra/outbound/deliver.ts")>(
  "../../infra/outbound/deliver.js",
);

const { routeReply } = await import("./route-reply.ts");
