...
import { resetSubagentRegistryForTests } from "../../agents/subagent-registry.ts";
import type { SpawnSubagentResult } from "../../agents/subagent-spawn.ts";
import type { OpenClawConfig } from "../../config/config.ts";
import { installSubagentsCommandCoreMocks } from "./commands-subagents.test-mocks.ts";
...
const { handleSubagentsCommand } = await import("./commands-subagents.ts");
const { buildCommandTestParams } = await import("./commands-spawn.test-harness.ts");
