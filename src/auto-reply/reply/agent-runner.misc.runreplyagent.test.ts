...
import { loadSessionStore, saveSessionStore } from "../../config/sessions.ts";
import { onAgentEvent } from "../../infra/agent-events.ts";
import type { TemplateContext } from "../templating.ts";
import type { FollowupRun, QueueSettings } from "./queue.ts";
...
vi.mock("../../agents/cli-runner.js", async () => {
  const actual = await vi.importActual<typeof import("../../agents/cli-runner.ts")>(
...
vi.mock("../../runtime.js", async () => {
  const actual = await vi.importActual<typeof import("../../runtime.ts")>("../../runtime.js");
  return {
    ...actual,
    defaultRuntime: {
...
vi.mock("./queue.js", async () => {
  const actual = await vi.importActual<typeof import("./queue.ts")>("./queue.js");
  return {
    ...actual,
