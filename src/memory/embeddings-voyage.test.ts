...
import * as authModule from "../agents/model-auth.ts";
import { type FetchMock, withFetchPreconnect } from "../test-utils/fetch-mock.ts";
import { createVoyageEmbeddingProvider, normalizeVoyageModel } from "./embeddings-voyage.ts";

vi.mock("../agents/model-auth.js", async () => {
  const { createModelAuthMockModule } = await import("../test-utils/model-auth-mock.ts");
