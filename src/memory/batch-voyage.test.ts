...
import type { VoyageBatchOutputLine, VoyageBatchRequest } from "./batch-voyage.ts";
...
describe("runVoyageEmbeddingBatches", () => {
  let runVoyageEmbeddingBatches: typeof import("./batch-voyage.ts").runVoyageEmbeddingBatches;

  beforeAll(async () => {
    ({ runVoyageEmbeddingBatches } = await import("./batch-voyage.ts"));
  });
