...
import { execDockerRaw } from "../agents/sandbox/docker.ts";
import { resolveBrowserConfig, resolveProfile } from "../browser/config.ts";
import { resolveBrowserControlAuth } from "../browser/control-auth.ts";
...
import { collectChannelSecurityFindings } from "./audit-channel.ts";
import {
