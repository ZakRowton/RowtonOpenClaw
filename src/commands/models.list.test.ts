...
let modelsListCommand: typeof import("./models/list.list-command.ts").modelsListCommand;
let loadModelRegistry: typeof import("./models/list.registry.ts").loadModelRegistry;
let toModelRow: typeof import("./models/list.registry.ts").toModelRow;
...
describe("models list/status", () => {
  ...
  beforeAll(async () => {
    ({ modelsListCommand } = await import("./models/list.list-command.ts"));
    ({ loadModelRegistry, toModelRow } = await import("./models/list.registry.ts"));
  });
