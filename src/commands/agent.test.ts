...
import { withTempHome as withTempHomeBase } from "../../test/helpers/temp-home.ts";
import "../cron/isolated-agent.mocks.ts";
import * as cliRunnerModule from "../agents/cli-runner.ts";
...
import * as sessionsModule from "../config/sessions.ts";
...
vi.mock("../agents/auth-profiles.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../agents/auth-profiles.ts")>();
  return {
    ...actual,
...
vi.mock("../agents/workspace.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../agents/workspace.ts")>();
  return {
    ...actual,
