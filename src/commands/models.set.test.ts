...
let modelsSetCommand: typeof import("./models/set.ts").modelsSetCommand;
let modelsFallbacksAddCommand: typeof import("./models/fallbacks.ts").modelsFallbacksAddCommand;

describe("models set + fallbacks", () => {
  beforeAll(async () => {
    ({ modelsSetCommand } = await import("./models/set.ts"));
    ({ modelsFallbacksAddCommand } = await import("./models/fallbacks.ts"));
  });
