...
import { discordOnboardingAdapter } from "../../channels/plugins/onboarding/discord.ts";
import { imessageOnboardingAdapter } from "../../channels/plugins/onboarding/imessage.ts";
import { signalOnboardingAdapter } from "../../channels/plugins/onboarding/signal.ts";
import { slackOnboardingAdapter } from "../../channels/plugins/onboarding/slack.ts";
import { telegramOnboardingAdapter } from "../../channels/plugins/onboarding/telegram.ts";
import { whatsappOnboardingAdapter } from "../../channels/plugins/onboarding/whatsapp.ts";
