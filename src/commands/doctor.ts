...
import { doctorShellCompletion } from "./doctor-completion.ts";
...
import { checkGatewayHealth, probeGatewayMemoryStatus } from "./doctor-gateway-health.ts";
import {
  maybeRepairGatewayServiceConfig,
  maybeScanExtraGatewayServices,
} from "./doctor-gateway-services.ts";
import { noteSourceInstallIssues } from "./doctor-install.ts";
import { noteMemorySearchHealth } from "./doctor-memory-search.ts";
import {
...
import { noteSessionLockHealth } from "./doctor-session-locks.ts";
