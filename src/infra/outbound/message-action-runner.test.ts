...
import { jsonResult } from "../../agents/tools/common.ts";
...
import { createIMessageTestPlugin } from "../../test-utils/imessage-test-plugin.ts";
import { loadWebMedia } from "../../web/media.ts";
import { resolvePreferredOpenClawTmpDir } from "../tmp-openclaw-dir.ts";
import { runMessageAction } from "./message-action-runner.ts";

vi.mock("../../web/media.js", async () => {
  const actual = await vi.importActual<typeof import("../../web/media.ts")>("../../web/media.js");
  return {
    ...actual,
...
let createPluginRuntime: typeof import("../../plugins/runtime/index.ts").createPluginRuntime;
let setSlackRuntime: typeof import("../../../extensions/slack/src/runtime.ts").setSlackRuntime;
let setTelegramRuntime: typeof import("../../../extensions/telegram/src/runtime.ts").setTelegramRuntime;
let setWhatsAppRuntime: typeof import("../../../extensions/whatsapp/src/runtime.ts").setWhatsAppRuntime;
...
describe("runMessageAction context isolation", () => {
  beforeAll(async () => {
    ({ createPluginRuntime } = await import("../../plugins/runtime/index.ts"));
    ({ setSlackRuntime } = await import("../../../extensions/slack/src/runtime.ts"));
    ({ setTelegramRuntime } = await import("../../../extensions/telegram/src/runtime.ts"));
    ({ setWhatsAppRuntime } = await import("../../../extensions/whatsapp/src/runtime.ts"));
  });
