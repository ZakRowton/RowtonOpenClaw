...
describe("update-startup", () => {
  ...
  let resolveOpenClawPackageRoot: (typeof import("./openclaw-root.ts"))["resolveOpenClawPackageRoot"];
  let checkUpdateStatus: (typeof import("./update-check.ts"))["checkUpdateStatus"];
  let resolveNpmChannelTag: (typeof import("./update-check.ts"))["resolveNpmChannelTag"];
  let runCommandWithTimeout: (typeof import("../process/exec.ts"))["runCommandWithTimeout"];
  let runGatewayUpdateCheck: (typeof import("./update-startup.ts"))["runGatewayUpdateCheck"];
  let scheduleGatewayUpdateCheck: (typeof import("./update-startup.ts"))["scheduleGatewayUpdateCheck"];
  let getUpdateAvailable: (typeof import("./update-startup.ts"))["getUpdateAvailable"];
  let resetUpdateAvailableStateForTest: (typeof import("./update-startup.ts"))["resetUpdateAvailableStateForTest"];
  let loaded = false;
  ...
  beforeEach(async () => {
    ...
    if (!loaded) {
      ({ resolveOpenClawPackageRoot } = await import("./openclaw-root.ts"));
      ({ checkUpdateStatus, resolveNpmChannelTag } = await import("./update-check.ts"));
      ({ runCommandWithTimeout } = await import("../process/exec.ts"));
      ({
        runGatewayUpdateCheck,
        scheduleGatewayUpdateCheck,
        getUpdateAvailable,
        resetUpdateAvailableStateForTest,
      } = await import("./update-startup.ts"));
      loaded = true;
    }
