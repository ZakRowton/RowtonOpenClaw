...
let resolveControlUiRepoRoot: typeof import("./control-ui-assets.ts").resolveControlUiRepoRoot;
let resolveControlUiDistIndexPath: typeof import("./control-ui-assets.ts").resolveControlUiDistIndexPath;
let resolveControlUiDistIndexHealth: typeof import("./control-ui-assets.ts").resolveControlUiDistIndexHealth;
let resolveControlUiRootOverrideSync: typeof import("./control-ui-assets.ts").resolveControlUiRootOverrideSync;
let resolveControlUiRootSync: typeof import("./control-ui-assets.ts").resolveControlUiRootSync;
let openclawRoot: typeof import("./openclaw-root.ts");
...
describe("control UI assets helpers (fs-mocked)", () => {
  beforeAll(async () => {
    ...
    } = await import("./control-ui-assets.ts"));
    openclawRoot = await import("./openclaw-root.ts");
  });
