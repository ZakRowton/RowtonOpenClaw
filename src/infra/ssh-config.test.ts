...
let parseSshConfigOutput: typeof import("./ssh-config.ts").parseSshConfigOutput;
let resolveSshConfig: typeof import("./ssh-config.ts").resolveSshConfig;

describe("ssh-config", () => {
  beforeAll(async () => {
    ({ parseSshConfigOutput, resolveSshConfig } = await import("./ssh-config.ts"));
  });
