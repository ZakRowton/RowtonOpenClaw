...
import { validateConfigObject } from "./config.ts";
import { buildWebSearchProviderConfig } from "./test-helpers.ts";

vi.mock("../runtime.js", () => ({
  defaultRuntime: { log: vi.fn(), error: vi.fn() },
}));

const { __testing } = await import("../agents/tools/web-search.ts");
