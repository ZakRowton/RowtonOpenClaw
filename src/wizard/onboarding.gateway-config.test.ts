...
import { createWizardPrompter as buildWizardPrompter } from "../../test/helpers/wizard-prompter.ts";
import type { RuntimeEnv } from "../runtime.ts";
import type { WizardPrompter, WizardSelectParams } from "./prompts.ts";
...
vi.mock("../commands/onboard-helpers.js", async (importActual) => {
  const actual = await importActual<typeof import("../commands/onboard-helpers.ts")>();
  return {
    ...actual,
