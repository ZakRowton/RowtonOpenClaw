...
let registerBrowserInspectCommands: typeof import("./browser-cli-inspect.ts").registerBrowserInspectCommands;
...
describe("browser cli snapshot defaults", () => {
  ...
  beforeAll(async () => {
    ({ registerBrowserInspectCommands } = await import("./browser-cli-inspect.ts"));
  });
