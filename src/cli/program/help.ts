...
import { hasFlag, hasRootVersionAlias } from "../argv.ts";
...
import { getCoreCliCommandsWithSubcommands } from "./command-registry.ts";
import type { ProgramContext } from "./context.ts";
import { getSubCliCommandsWithSubcommands } from "./register.subclis.ts";
