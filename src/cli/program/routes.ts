...
const routeSessions: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { sessionsCommand } = await import("../../commands/sessions.ts");
...
const routeAgentsList: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { agentsListCommand } = await import("../../commands/agents.ts");
...
const routeMemoryStatus: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { runMemoryStatus } = await import("../memory-cli.ts");
...
const routeConfigGet: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const json = hasFlag(argv, "--json");
    const { runConfigGet } = await import("../config-cli.ts");
...
const routeConfigUnset: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { runConfigUnset } = await import("../config-cli.ts");
...
const routeModelsList: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { modelsListCommand } = await import("../../commands/models.ts");
...
const routeModelsStatus: RouteSpec = {
  ...
  run: async (argv) => {
    ...
    const { modelsStatusCommand } = await import("../../commands/models.ts");
