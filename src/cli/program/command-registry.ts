...
const coreEntries: CoreCliEntry[] = [
  {
    ...
    register: async ({ program }) => {
      const mod = await import("./register.setup.ts");
  ...
  },
  {
    ...
    register: async ({ program }) => {
      const mod = await import("./register.onboard.ts");
  ...
  },
  {
    ...
    register: async ({ program }) => {
      const mod = await import("./register.configure.ts");
  ...
  },
  {
    ...
    register: async ({ program }) => {
      const mod = await import("../config-cli.ts");
  ...
  },
  {
    ...
    register: async ({ program }) => {
      const mod = await import("./register.maintenance.ts");
  ...
  },
  {
    ...
    register: async ({ program, ctx }) => {
      const mod = await import("./register.message.ts");
  ...
  },
  {
    ...
    register: async ({ program }) => {
      const mod = await import("../memory-cli.ts");
  ...
  },
  {
    ...
    register: async ({ program, ctx }) => {
      const mod = await import("./register.agent.ts");
  ...
  },
  {
    ...
    register: async ({ program }) => {
      const mod = await import("./register.status-health-sessions.ts");
  ...
  },
  {
    ...
    register: async ({ program }) => {
      const mod = await import("../browser-cli.ts");
