...
let registerStatusHealthSessionsCommands: typeof import("./register.status-health-sessions.ts").registerStatusHealthSessionsCommands;

beforeAll(async () => {
  ({ registerStatusHealthSessionsCommands } = await import("./register.status-health-sessions.ts"));
});
