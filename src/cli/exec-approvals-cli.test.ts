...
import { createCliRuntimeCapture } from "./test-runtime-capture.ts";
...
vi.mock("./nodes-cli/rpc.js", async () => {
  const actual = await vi.importActual<typeof import("./nodes-cli/rpc.ts")>("./nodes-cli/rpc.js");
  return {
    ...actual,
...
vi.mock("../infra/exec-approvals.js", async () => {
  const actual = await vi.importActual<typeof import("../infra/exec-approvals.ts")>(
...
const { registerExecApprovalsCli } = await import("./exec-approvals-cli.ts");
const execApprovals = await import("../infra/exec-approvals.ts");
