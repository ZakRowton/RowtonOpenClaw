...
let registerMemoryCli: typeof import("./memory-cli.ts").registerMemoryCli;
let defaultRuntime: typeof import("../runtime.ts").defaultRuntime;
let isVerbose: typeof import("../globals.ts").isVerbose;
let setVerbose: typeof import("../globals.ts").setVerbose;

beforeAll(async () => {
  ({ registerMemoryCli } = await import("./memory-cli.ts"));
  ({ defaultRuntime } = await import("../runtime.ts"));
  ({ isVerbose, setVerbose } = await import("../globals.ts"));
});
