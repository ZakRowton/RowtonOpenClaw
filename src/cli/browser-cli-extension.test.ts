...
let resolveBundledExtensionRootDir: typeof import("./browser-cli-extension.ts").resolveBundledExtensionRootDir;
let installChromeExtension: typeof import("./browser-cli-extension.ts").installChromeExtension;
let registerBrowserExtensionCommands: typeof import("./browser-cli-extension.ts").registerBrowserExtensionCommands;

beforeAll(async () => {
  ({ resolveBundledExtensionRootDir, installChromeExtension, registerBrowserExtensionCommands } =
    await import("./browser-cli-extension.ts"));
});
